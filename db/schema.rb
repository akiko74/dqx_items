...
ActiveRecord::Schema.define(version: 20140917232525) do
  ...
  add_index "ingredients", ["recipe_id", "item_id"], name: "index_ingredients_on_recipe_id_and_item_id", unique: true, using: :btree
